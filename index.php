...
<h5 style="color:red; font: size 20px;"> <?php if(isset($error)) echo  $error ?></h5>
            ...
            <div class="row">
                ...
                <textarea id="message" class="input"  name="message" rows="7" cols="30"><?php if(isset($message)) echo $message?></textarea><br />
